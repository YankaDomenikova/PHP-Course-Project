    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" mt-2" style="margin-bottom: 20px;">
                <a href="/teacher" class="font-bold py-2 px-4 rounded panel-btn color-main">Add teacher</a>
            </div>
            <div class="overflow-hidden" >

                <table class="glass-table panel-table color-main overflow-hidden">
                    ...
                    @foreach($teacher as $t)
                        <tr>
                            ...
                            <td class="p-3 px-5 flex">
                                <a href="/edit_teacher/{{$t->id}}" name="edit" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700  py-1 px-2 rounded focus:outline-none focus:shadow-outline flex items-center">
