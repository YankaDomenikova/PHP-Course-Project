            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <form method="POST" action="/organization" >
                    ...
                    <div class="form-group">
                        <textarea name="organization_name" class="bg-gray-100 rounded"  placeholder='Name'></textarea>
                    ...
                    <div class="form-group">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded">Add Organization</button>
                    </div>
                    {{ csrf_field() }}
                </form>
            </div>
